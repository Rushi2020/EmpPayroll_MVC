...
namespace RepositoryLayer
{
    ...
    {
        string connectionString = "Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=employeeMvc;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
        ...
        public UserModel GetEmployeeData(int? id)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                string sqlQuery = "SELECT * FROM employeePayroll WHERE Employeeid= " + id;
